...
var RegisterService = (function () {
    function RegisterService(_httpService) {
    ...
    RegisterService.prototype.get = function (val) {
    ...
    RegisterService.prototype.register = function (param) {
        ...
        return this._httpService
            ...
            var userid = obj[Object.keys(obj)[0]];
            if (userid) {
                return true;
            }
            else {
